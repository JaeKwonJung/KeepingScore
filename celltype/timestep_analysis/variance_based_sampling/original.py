...
parser.add_argument("--T", type=int, default=1000, help="Number of diffusion steps for evaluation")
...
parser.add_argument("--save_dir", type=str, default="./checkpoints/original")
...
unique_test_labels = unique_labels  # use TRAIN ORDER
class_mean_embeds = []
class_n_cells = []
